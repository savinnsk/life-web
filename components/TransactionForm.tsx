...
import { ArrowDownLeft, ArrowUpRight, Calendar, DollarSign, FileText, Tag, X } from 'lucide-react';
...
export default function TransactionForm({ transaction, onSave, onCancel }: TransactionFormProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[9999] flex items-end justify-center">
            <div className="bg-white dark:bg-gray-800 rounded-t-2xl w-full max-w-md max-h-[85vh] flex flex-col shadow-2xl mx-4">
